...
#     class Base
#       
#       attr_accessor :view_binder # The Mack::Rendering::ViewTemplate that called this rendering system.
...
#       needs_method :render
#       
#       # Maps to the view_binder's param method. See also Mack::Rendering::ViewTemplate params.
#       def params(key)
...
#         return Mack::Rendering::ViewTemplate.render(File.open(partial).read, self.view_binder.controller, options)
#       end
#       
#     end # Base
#   end # Rendering
