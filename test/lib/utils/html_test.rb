...
class HtmlHelpersTest < Test::Unit::TestCase
  ...
  def test_href
    assert_equal "<a href=\"http://www.mackframework.com\">http://www.mackframework.com</a>", Mack::Utils::Html.a("http://www.mackframework.com")
    
    assert_equal "<a href=\"http://www.mackframework.com\">Mack</a>", Mack::Utils::Html.a("Mack", :href => "http://www.mackframework.com")
    
    assert_equal "<a href=\"http://www.mackframework.com\" target=\"_blank\">Mack</a>", Mack::Utils::Html.a("Mack", :href => "http://www.mackframework.com", :target => "_blank")
    
    assert_equal %{<a href="http://www.mackframework.com" onclick="var f = document.createElement('form'); f.style.display = 'none'; this.parentNode.appendChild(f); f.method = 'POST'; f.action = this.href;var s = document.createElement('input'); s.setAttribute('type', 'hidden'); s.setAttribute('name', '_method'); s.setAttribute('value', 'delete'); f.appendChild(s);f.submit();return false;">Mack</a>}, Mack::Utils::Html.a("Mack", :href => "http://www.mackframework.com", :method => :delete)
    ...
    link = Mack::Utils::Html.a("Mack", :href => "http://www.mackframework.com", :method => :update, :confirm => "Are you sure?")
  ...
  def test_method_missing
    ...
    assert_equal Mack::Utils::Html.href("Mack", :href => "http://www.mackframework.com", :method => :update, :confirm => "Are you sure?"), Mack::Utils::Html.a("Mack", :href => "http://www.mackframework.com", :method => :update, :confirm => "Are you sure?")
  end
